...
def add_final_retrain_ops(class_count, final_tensor_name, bottleneck_tensor,
 ...
 # Source: https://stackoverflow.com/questions/46983334/adding-two-addtional-layers-to-inception-with-transfer-learning?rq=1
  ...
  with tf.name_scope(layer_name):
    ...
    with tf.name_scope('tanh_activation'):
      tanh_activation = tf.nn.tanh(logits, name="Tanh")
      tf.summary.histogram('final_sigmoid_activations', logits)
  '''
  # layer 2
  # Source: https://stackoverflow.com/questions/46983334/adding-two-addtional-layers-to-inception-with-transfer-learning?rq=1
  layer_name = 'layer_leaky_relu'
  with tf.name_scope(layer_name):
    with tf.name_scope('weights'):
      initial_value = tf.truncated_normal(
    ...
    with tf.name_scope('relu_activation'):
      relu_activated = tf.nn.leaky_relu(logits, name="Relu")
...
#python retrain_with_device.py --image_dir food41/train/ --tfhub_module https://tfhub.dev/google/imagenet/mobilenet_v1_100_224/quantops/feature_vector/1
